# Create the .turbo\_test.yml file

The `.turbo_test.yml` file is where you specify everything Turbo Test needs to know to run your test suite. It is described in [the configuration file section](../config-file/).
